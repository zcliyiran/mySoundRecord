...
import com.zcliyiran.mysoundrecorder.RecordingService;
...
public class RecordFragment extends Fragment {
    ...
    private void onRecord(boolean start) {
        ...
        if (start) {
            ...
            mChronometer.stop();
            mChronometer.setBase(SystemClock.elapsedRealtime());//获取从设备boot后经历的时间值。
            timeWhenPaused = 0;
...
//    private void onRecord(boolean start){
//
//        Intent intent = new Intent(getActivity(),com.zcliyiran.mysoundrecorder.RecordingService.class);
//
//        if (start) {
//            // start recording
//            mRecordButton.setImageResource(R.mipmap.ic_media_stop);
